...
import { index, store, update } from "@/routes/admin/tables"
...
export default function TableCreate({table}:TableProps) {

  const handleCancel = () => window.history.back()

  return (
    <AppLayout breadcrumbs={breadcrumbs}>
      <Head title="Edit-Table-Details" />
