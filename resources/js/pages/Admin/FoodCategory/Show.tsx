                            ...
                            <CardContent className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="flex items-center space-x-2">
                                        <div
                                            className={`w-3 h-3 rounded-full ${foodCategory.status ? "bg-emerald-500" : "bg-gray-400"
                                                }`}
                                        />
                                        <span className={`font-medium ${foodCategory.status ? "text-emerald-700" : "text-gray-600"
                                            }`}>
