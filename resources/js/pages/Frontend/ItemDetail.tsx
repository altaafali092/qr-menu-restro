...
import { ArrowLeft, CircleArrowRight, MailWarning, MousePointer2Icon, ShoppingCart } from "lucide-react";
...
const ItemDetail = ({ menuItem }: MenuItemProps) => {
    ...
    console.log("category", menuItem.sub_food_category_id)
                            ...
                            <div className="flex gap-4 items-center text-sm text-gray-600">
                                {menuItem.sub_food_category?.name && (
                                    <div className="flex items-center gap-1.5">
                                        ...
                                        <span>{menuItem.sub_food_category?.name}</span>
                                    </div>
                                )}

                                {menuItem.sub_food_category?.food_category?.name && (
                                    <div className="flex items-center gap-1.5">
                                        <CircleArrowRight className="w-4 h-4" />
                                        <span>{menuItem.sub_food_category?.food_category?.name}</span>
                                    </div>
                                )}
                            </div>
